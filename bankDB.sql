...
('def', 'sql9169410', 'branches', 'branch_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'sql9169410', 'branches', 'branch_name', 2, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_contact', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_contact', 'street', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_contact', 'city', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_contact', 'state', 4, NULL, 'NO', 'varchar', 2, 2, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_contact', 'zip', 5, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_contact', 'phone', 6, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_sales', 'sale_no', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_sales', 'prod_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'MUL', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_sales', 'employee_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'MUL', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_sales', 'date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employee_sales', 'branch_id', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'MUL', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employees', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'sql9169410', 'employees', 'first_name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employees', 'last_name', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'employees', 'branch_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'MUL', '', 'select,insert,update', ''),
('def', 'sql9169410', 'products', 'prod_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', 'auto_increment', 'select,insert,update', ''),
('def', 'sql9169410', 'products', 'prod_name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'terminated_employees', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'PRI', '', 'select,insert,update', ''),
('def', 'sql9169410', 'terminated_employees', 'first_name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'terminated_employees', 'last_name', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
('def', 'sql9169410', 'terminated_employees', 'branch_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', 'MUL', '', 'select,insert,update', '');
...
('ABORTED_CLIENTS', '110574'),
('ABORTED_CONNECTS', '1961029'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '0'),
('BYTES_RECEIVED', '26975649429'),
('BYTES_SENT', '109982665000'),
('COM_ADMIN_COMMANDS', '47782935'),
...
('COM_ALTER_SERVER', '0'),
('COM_ALTER_TABLE', '19947'),
('COM_ALTER_TABLESPACE', '0'),
('COM_ANALYZE', '1'),
('COM_BEGIN', '26013'),
('COM_BINLOG', '0'),
('COM_CALL_PROCEDURE', '213'),
('COM_CHANGE_DB', '1390876'),
('COM_CHANGE_MASTER', '0'),
('COM_CHECK', '13'),
('COM_CHECKSUM', '0'),
('COM_COMMIT', '311161'),
...
('COM_CREATE_INDEX', '3486'),
('COM_CREATE_PROCEDURE', '960'),
('COM_CREATE_SERVER', '0'),
('COM_CREATE_TABLE', '52248'),
('COM_CREATE_TRIGGER', '331'),
('COM_CREATE_UDF', '0'),
('COM_CREATE_USER', '1251'),
('COM_CREATE_VIEW', '42'),
('COM_DEALLOC_SQL', '80'),
('COM_DELETE', '250667'),
('COM_DELETE_MULTI', '152'),
('COM_DO', '10011'),
('COM_DROP_DB', '180'),
('COM_DROP_EVENT', '6'),
('COM_DROP_FUNCTION', '1'),
('COM_DROP_INDEX', '6'),
('COM_DROP_PROCEDURE', '83'),
('COM_DROP_SERVER', '0'),
('COM_DROP_TABLE', '8107'),
('COM_DROP_TRIGGER', '3'),
('COM_DROP_USER', '0'),
...
('COM_RELEASE_SAVEPOINT', '38019'),
('COM_RENAME_TABLE', '93'),
('COM_RENAME_USER', '1231'),
('COM_REPAIR', '13'),
('COM_REPLACE', '2116'),
...
('COM_SAVEPOINT', '38019'),
('COM_SELECT', '25568674'),
('COM_SET_OPTION', '9633161'),
('COM_SIGNAL', '0'),
('COM_SHOW_AUTHORS', '0'),
('COM_SHOW_BINLOG_EVENTS', '0'),
('COM_SHOW_BINLOGS', '6430'),
('COM_SHOW_CHARSETS', '405'),
('COM_SHOW_COLLATIONS', '206276'),
('COM_SHOW_CONTRIBUTORS', '0'),
('COM_SHOW_CREATE_DB', '195'),
('COM_SHOW_CREATE_EVENT', '0'),
('COM_SHOW_CREATE_FUNC', '4'),
('COM_SHOW_CREATE_PROC', '119'),
('COM_SHOW_CREATE_TABLE', '45882'),
('COM_SHOW_CREATE_TRIGGER', '0'),
('COM_SHOW_DATABASES', '19263'),
('COM_SHOW_ENGINE_LOGS', '0'),
('COM_SHOW_ENGINE_MUTEX', '0'),
('COM_SHOW_ENGINE_STATUS', '1'),
('COM_SHOW_EVENTS', '165'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '272836'),
('COM_SHOW_FUNCTION_STATUS', '2159'),
('COM_SHOW_GRANTS', '4291'),
('COM_SHOW_KEYS', '40621'),
('COM_SHOW_MASTER_STATUS', '7227'),
('COM_SHOW_OPEN_TABLES', '9'),
('COM_SHOW_PLUGINS', '3706'),
('COM_SHOW_PRIVILEGES', '0'),
('COM_SHOW_PROCEDURE_STATUS', '2162'),
('COM_SHOW_PROCESSLIST', '12199'),
('COM_SHOW_PROFILE', '11'),
('COM_SHOW_PROFILES', '6'),
('COM_SHOW_RELAYLOG_EVENTS', '0'),
('COM_SHOW_SLAVE_HOSTS', '0'),
('COM_SHOW_SLAVE_STATUS', '7281'),
('COM_SHOW_STATUS', '77018'),
('COM_SHOW_STORAGE_ENGINES', '2522'),
('COM_SHOW_TABLE_STATUS', '114016'),
('COM_SHOW_TABLES', '103008'),
('COM_SHOW_TRIGGERS', '9352'),
('COM_SHOW_VARIABLES', '288273'),
('COM_SHOW_WARNINGS', '25821'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '858366'),
('COM_STMT_EXECUTE', '889955'),
('COM_STMT_FETCH', '0'),
('COM_STMT_PREPARE', '876263'),
('COM_STMT_REPREPARE', '136'),
('COM_STMT_RESET', '158082'),
('COM_STMT_SEND_LONG_DATA', '0'),
('COM_TRUNCATE', '1681'),
('COM_UNINSTALL_PLUGIN', '0'),
('COM_UNLOCK_TABLES', '603'),
('COM_UPDATE', '16038790'),
('COM_UPDATE_MULTI', '474'),
('COM_XA_COMMIT', '0'),
('COM_XA_END', '0'),
('COM_XA_PREPARE', '0'),
('COM_XA_RECOVER', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '9875324'),
('CREATED_TMP_DISK_TABLES', '483107'),
('CREATED_TMP_FILES', '14437'),
('CREATED_TMP_TABLES', '2248755'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '1240'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '37698695'),
('HANDLER_DELETE', '710554'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '10753837'),
('HANDLER_READ_KEY', '136514775'),
('HANDLER_READ_LAST', '12399'),
('HANDLER_READ_NEXT', '26307325906'),
('HANDLER_READ_PREV', '1056902'),
('HANDLER_READ_RND', '154564355'),
('HANDLER_READ_RND_NEXT', '47815044140'),
('HANDLER_ROLLBACK', '6373977'),
('HANDLER_SAVEPOINT', '37584'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '73072012'),
('HANDLER_WRITE', '1992723375'),
('INNODB_BUFFER_POOL_PAGES_DATA', '7952'),
('INNODB_BUFFER_POOL_BYTES_DATA', '130285568'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '15'),
('INNODB_BUFFER_POOL_BYTES_DIRTY', '245760'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '40180011'),
('INNODB_BUFFER_POOL_PAGES_FREE', '1'),
('INNODB_BUFFER_POOL_PAGES_MISC', '239'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '43752'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '8201'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '55109226279'),
('INNODB_BUFFER_POOL_READS', '4410905'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '261096799'),
('INNODB_DATA_FSYNCS', '19365139'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '73059930112'),
('INNODB_DATA_READS', '4462696'),
('INNODB_DATA_WRITES', '58916171'),
('INNODB_DATA_WRITTEN', '1346576695296'),
('INNODB_DBLWR_PAGES_WRITTEN', '40180011'),
('INNODB_DBLWR_WRITES', '906021'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '46533260'),
('INNODB_LOG_WRITES', '16985626'),
('INNODB_OS_LOG_FSYNCS', '17555576'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '29665288192'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '443514'),
('INNODB_PAGES_READ', '4458962'),
('INNODB_PAGES_WRITTEN', '40180011'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '770349'),
('INNODB_ROW_LOCK_TIME_AVG', '247'),
('INNODB_ROW_LOCK_TIME_MAX', '51028'),
('INNODB_ROW_LOCK_WAITS', '3110'),
('INNODB_ROWS_DELETED', '636243'),
('INNODB_ROWS_INSERTED', '36841330'),
('INNODB_ROWS_READ', '71479253637'),
('INNODB_ROWS_UPDATED', '15124913'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '13354'),
('KEY_BLOCKS_USED', '13396'),
('KEY_READ_REQUESTS', '44943502'),
('KEY_READS', '999464'),
('KEY_WRITE_REQUESTS', '5733991'),
('KEY_WRITES', '2413962'),
...
('OPEN_TABLES', '399'),
('OPENED_FILES', '88961381'),
('OPENED_TABLE_DEFINITIONS', '59531240'),
('OPENED_TABLES', '59433926'),
...
('QCACHE_FREE_MEMORY', '6503240'),
('QCACHE_HITS', '34350580'),
('QCACHE_INSERTS', '16388813'),
('QCACHE_LOWMEM_PRUNES', '4429177'),
('QCACHE_NOT_CACHED', '9159475'),
('QCACHE_QUERIES_IN_CACHE', '7113'),
('QCACHE_TOTAL_BLOCKS', '16189'),
('QUERIES', '148815742'),
('QUESTIONS', '99140898'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '9089'),
('SELECT_FULL_RANGE_JOIN', '220'),
('SELECT_RANGE', '416934'),
('SELECT_RANGE_CHECK', '60081'),
('SELECT_SCAN', '8106230'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '42378056'),
('TABLE_LOCKS_WAITED', '102'),
('TC_LOG_MAX_PAGES_USED', '0'),
('TC_LOG_PAGE_SIZE', '0'),
('TC_LOG_PAGE_WAITS', '0'),
('THREADS_CACHED', '7'),
('THREADS_CONNECTED', '27'),
('THREADS_CREATED', '59735'),
('THREADS_RUNNING', '1'),
('UPTIME', '6111553'),
('UPTIME_SINCE_FLUSH_STATUS', '6111553');
...
('OLD_PASSWORDS', 'OFF'),
('GENERAL_LOG_FILE', '/var/lib/mysql/ip-172-31-35-11.log'),
...
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/ip-172-31-35-11-slow.log'),
...
('def', 'sql9169410', 'PRIMARY', 'def', 'sql9169410', 'branches', 'branch_id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'branch_id', 'def', 'sql9169410', 'branches', 'branch_id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'PRIMARY', 'def', 'sql9169410', 'employee_contact', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'id', 'def', 'sql9169410', 'employee_contact', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'PRIMARY', 'def', 'sql9169410', 'employee_sales', 'sale_no', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'sale_no', 'def', 'sql9169410', 'employee_sales', 'sale_no', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'employee_sales_ibfk_1', 'def', 'sql9169410', 'employee_sales', 'prod_id', 1, 1, 'sql9169410', 'products', 'prod_id'),
('def', 'sql9169410', 'employee_sales_ibfk_2', 'def', 'sql9169410', 'employee_sales', 'branch_id', 1, 1, 'sql9169410', 'branches', 'branch_id'),
('def', 'sql9169410', 'employee_sales_ibfk_3', 'def', 'sql9169410', 'employee_sales', 'employee_id', 1, 1, 'sql9169410', 'employee_contact', 'id'),
('def', 'sql9169410', 'PRIMARY', 'def', 'sql9169410', 'employees', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'id', 'def', 'sql9169410', 'employees', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'employees_ibfk_1', 'def', 'sql9169410', 'employees', 'branch_id', 1, 1, 'sql9169410', 'branches', 'branch_id'),
('def', 'sql9169410', 'PRIMARY', 'def', 'sql9169410', 'products', 'prod_id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'prod_id', 'def', 'sql9169410', 'products', 'prod_id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'PRIMARY', 'def', 'sql9169410', 'terminated_employees', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'id', 'def', 'sql9169410', 'terminated_employees', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'sql9169410', 'terminated_employees_ibfk_1', 'def', 'sql9169410', 'terminated_employees', 'branch_id', 1, 1, 'sql9169410', 'branches', 'branch_id');
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-11 00:39:52', '2017-05-11 00:39:52', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 16766844, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 16332350, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 16765866, 0, 0, '2017-05-11 00:39:52', NULL, NULL, NULL, '', '', NULL),
('def', 'sql9169410', 'branches', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 16384, 0, '2017-04-16 16:36:49', NULL, NULL, NULL, '', '', NULL),
('def', 'sql9169410', 'employee_contact', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 54, 303, 16384, NULL, 16384, 0, '2017-04-16 16:36:49', NULL, NULL, NULL, '', '', NULL),
('def', 'sql9169410', 'employee_sales', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 67, 244, 16384, NULL, 65536, 0, '2017-04-16 16:36:50', NULL, NULL, NULL, '', '', NULL),
('def', 'sql9169410', 'employees', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 48, 341, 16384, NULL, 32768, 0, '2017-04-16 16:36:50', NULL, NULL, NULL, '', '', NULL),
('def', 'sql9169410', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 1638, 16384, NULL, 16384, 0, '2017-04-16 16:36:50', NULL, NULL, NULL, '', '', NULL),
('def', 'sql9169410', 'terminated_employees', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 32768, 0, '2017-04-16 16:36:50', NULL, NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL', 'FORCE'),
...
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL', 'FORCE'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL', 'FORCE'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL', 'FORCE'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'MySQL AB', 'MyISAM storage engine', 'GPL', 'FORCE'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL', 'OFF'),
('InnoDB', '5.5', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'Oracle Corporation', 'Supports transactions, row-level locking, and foreign keys', 'GPL', 'ON'),
('INNODB_TRX', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'InnoDB transactions', 'GPL', 'ON'),
('INNODB_LOCKS', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'InnoDB conflicting locks', 'GPL', 'ON'),
('INNODB_LOCK_WAITS', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'InnoDB which lock is blocking which', 'GPL', 'ON'),
('INNODB_CMP', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compression', 'GPL', 'ON'),
('INNODB_CMP_RESET', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compression; reset cumulated counts', 'GPL', 'ON'),
('INNODB_CMPMEM', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compressed buffer pool', 'GPL', 'ON'),
('INNODB_CMPMEM_RESET', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'Statistics for the InnoDB compressed buffer pool; reset cumulated counts', 'GPL', 'ON'),
('INNODB_BUFFER_PAGE', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'InnoDB Buffer Page Information', 'GPL', 'ON'),
('INNODB_BUFFER_PAGE_LRU', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'InnoDB Buffer Page in LRU', 'GPL', 'ON'),
('INNODB_BUFFER_POOL_STATS', '5.5', 'ACTIVE', 'INFORMATION SCHEMA', '50550.0', NULL, NULL, 'Oracle Corporation', 'InnoDB Buffer Pool Statistics Information ', 'GPL', 'ON'),
('PERFORMANCE_SCHEMA', '0.1', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'Marc Alff, Oracle', 'Performance Schema', 'GPL', 'FORCE'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL', 'ON'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL', 'ON'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50550.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL', 'ON');
...
(9875317, 'sql9169410', 'web12.extendcp.co.uk:58692', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'sql9169410', 'employee_sales_ibfk_1', 'def', 'sql9169410', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'employee_sales', 'products'),
('def', 'sql9169410', 'employee_sales_ibfk_2', 'def', 'sql9169410', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'employee_sales', 'branches'),
('def', 'sql9169410', 'employee_sales_ibfk_3', 'def', 'sql9169410', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'employee_sales', 'employee_contact'),
('def', 'sql9169410', 'employees_ibfk_1', 'def', 'sql9169410', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'employees', 'branches'),
('def', 'sql9169410', 'terminated_employees_ibfk_1', 'def', 'sql9169410', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'terminated_employees', 'branches');
...
('def', 'sql9169410', 'latin1', 'latin1_swedish_ci', NULL);
...
('''sql9169410''@''%''', 'def', 'sql9169410', 'SELECT', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'INSERT', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'UPDATE', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'DELETE', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'CREATE', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'DROP', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'INDEX', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'ALTER', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'LOCK TABLES', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'EXECUTE', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'CREATE VIEW', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'SHOW VIEW', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'CREATE ROUTINE', 'NO'),
('''sql9169410''@''%''', 'def', 'sql9169410', 'ALTER ROUTINE', 'NO');
...
('HANDLER_READ_KEY', '0'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '1960'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '1853'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
...
('INNODB_BUFFER_POOL_BYTES_DIRTY', '212992'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '40180026'),
('INNODB_BUFFER_POOL_PAGES_FREE', '1'),
('INNODB_BUFFER_POOL_PAGES_MISC', '239'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '43752'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '8201'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '55109226334'),
('INNODB_BUFFER_POOL_READS', '4410905'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '261096822'),
('INNODB_DATA_FSYNCS', '19365147'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '73059930112'),
('INNODB_DATA_READS', '4462696'),
('INNODB_DATA_WRITES', '58916193'),
('INNODB_DATA_WRITTEN', '1346577190912'),
('INNODB_DBLWR_PAGES_WRITTEN', '40180026'),
('INNODB_DBLWR_WRITES', '906022'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '46533262'),
('INNODB_LOG_WRITES', '16985631'),
('INNODB_OS_LOG_FSYNCS', '17555582'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '29665291776'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '443514'),
('INNODB_PAGES_READ', '4458962'),
('INNODB_PAGES_WRITTEN', '40180026'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '770349'),
('INNODB_ROW_LOCK_TIME_AVG', '247'),
('INNODB_ROW_LOCK_TIME_MAX', '51028'),
('INNODB_ROW_LOCK_WAITS', '3110'),
('INNODB_ROWS_DELETED', '636243'),
('INNODB_ROWS_INSERTED', '36841332'),
('INNODB_ROWS_READ', '71479253646'),
('INNODB_ROWS_UPDATED', '15124916'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '13354'),
('KEY_BLOCKS_USED', '13396'),
('KEY_READ_REQUESTS', '44943672'),
('KEY_READS', '999464'),
('KEY_WRITE_REQUESTS', '5733991'),
('KEY_WRITES', '2413962'),
...
('PERFORMANCE_SCHEMA_THREAD_INSTANCES_LOST', '0'),
('PREPARED_STMT_COUNT', '0'),
('QCACHE_FREE_BLOCKS', '1808'),
('QCACHE_FREE_MEMORY', '6513416'),
('QCACHE_HITS', '34350603'),
('QCACHE_INSERTS', '16388833'),
('QCACHE_LOWMEM_PRUNES', '4429205'),
('QCACHE_NOT_CACHED', '9159494'),
('QCACHE_QUERIES_IN_CACHE', '7105'),
('QCACHE_TOTAL_BLOCKS', '16185'),
('QUERIES', '148815912'),
('QUESTIONS', '134'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '0'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '42378089'),
('TABLE_LOCKS_WAITED', '102'),
('TC_LOG_MAX_PAGES_USED', '0'),
('TC_LOG_PAGE_SIZE', '0'),
('TC_LOG_PAGE_WAITS', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '6111559'),
('UPTIME_SINCE_FLUSH_STATUS', '6111559');
...
('def', 'sql9169410', 'branches', 0, 'sql9169410', 'PRIMARY', 1, 'branch_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'branches', 0, 'sql9169410', 'branch_id', 1, 'branch_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_contact', 0, 'sql9169410', 'PRIMARY', 1, 'id', 'A', 54, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_contact', 0, 'sql9169410', 'id', 1, 'id', 'A', 54, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_sales', 0, 'sql9169410', 'PRIMARY', 1, 'sale_no', 'A', 67, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_sales', 0, 'sql9169410', 'sale_no', 1, 'sale_no', 'A', 67, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_sales', 1, 'sql9169410', 'prod_id', 1, 'prod_id', 'A', 22, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_sales', 1, 'sql9169410', 'branch_id', 1, 'branch_id', 'A', 22, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employee_sales', 1, 'sql9169410', 'employee_id', 1, 'employee_id', 'A', 67, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employees', 0, 'sql9169410', 'PRIMARY', 1, 'id', 'A', 48, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employees', 0, 'sql9169410', 'id', 1, 'id', 'A', 48, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'employees', 1, 'sql9169410', 'branch_id', 1, 'branch_id', 'A', 24, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'products', 0, 'sql9169410', 'PRIMARY', 1, 'prod_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'products', 0, 'sql9169410', 'prod_id', 1, 'prod_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'terminated_employees', 0, 'sql9169410', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'terminated_employees', 0, 'sql9169410', 'id', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'sql9169410', 'terminated_employees', 1, 'sql9169410', 'branch_id', 1, 'branch_id', 'A', 2, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-11 00:39:57', '2017-05-11 00:39:57', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 16766844, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2448', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 16332350, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=65280', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 16765866, 0, 0, NULL, '2017-05-11 00:39:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2515', ''),
('def', 'sql9169410', 'branches', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 16384, 28311552, 10, '2017-04-16 16:36:49', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'sql9169410', 'employee_contact', 'BASE TABLE', 'InnoDB', 10, 'Compact', 54, 303, 16384, 0, 16384, 28311552, NULL, '2017-04-16 16:36:49', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'sql9169410', 'employee_sales', 'BASE TABLE', 'InnoDB', 10, 'Compact', 67, 244, 16384, 0, 65536, 28311552, 68, '2017-04-16 16:36:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'sql9169410', 'employees', 'BASE TABLE', 'InnoDB', 10, 'Compact', 48, 341, 16384, 0, 32768, 28311552, 68, '2017-04-16 16:36:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'sql9169410', 'products', 'BASE TABLE', 'InnoDB', 10, 'Compact', 10, 1638, 16384, 0, 16384, 28311552, 11, '2017-04-16 16:36:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'sql9169410', 'terminated_employees', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 32768, 28311552, NULL, '2017-04-16 16:36:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'sql9169410', 'PRIMARY', 'sql9169410', 'branches', 'PRIMARY KEY'),
('def', 'sql9169410', 'branch_id', 'sql9169410', 'branches', 'UNIQUE'),
('def', 'sql9169410', 'PRIMARY', 'sql9169410', 'employee_contact', 'PRIMARY KEY'),
('def', 'sql9169410', 'id', 'sql9169410', 'employee_contact', 'UNIQUE'),
('def', 'sql9169410', 'PRIMARY', 'sql9169410', 'employee_sales', 'PRIMARY KEY'),
('def', 'sql9169410', 'sale_no', 'sql9169410', 'employee_sales', 'UNIQUE'),
('def', 'sql9169410', 'employee_sales_ibfk_1', 'sql9169410', 'employee_sales', 'FOREIGN KEY'),
('def', 'sql9169410', 'employee_sales_ibfk_2', 'sql9169410', 'employee_sales', 'FOREIGN KEY'),
('def', 'sql9169410', 'employee_sales_ibfk_3', 'sql9169410', 'employee_sales', 'FOREIGN KEY'),
('def', 'sql9169410', 'PRIMARY', 'sql9169410', 'employees', 'PRIMARY KEY'),
('def', 'sql9169410', 'id', 'sql9169410', 'employees', 'UNIQUE'),
('def', 'sql9169410', 'employees_ibfk_1', 'sql9169410', 'employees', 'FOREIGN KEY'),
('def', 'sql9169410', 'PRIMARY', 'sql9169410', 'products', 'PRIMARY KEY'),
('def', 'sql9169410', 'prod_id', 'sql9169410', 'products', 'UNIQUE'),
('def', 'sql9169410', 'PRIMARY', 'sql9169410', 'terminated_employees', 'PRIMARY KEY'),
('def', 'sql9169410', 'id', 'sql9169410', 'terminated_employees', 'UNIQUE'),
('def', 'sql9169410', 'terminated_employees_ibfk_1', 'sql9169410', 'terminated_employees', 'FOREIGN KEY');
...
-- Database: `sql9169410`
--
CREATE DATABASE `sql9169410` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sql9169410`;
...
INSERT INTO `employee_contact` (`id`, `street`, `city`, `state`, `zip`, `phone`) VALUES
(1, '425 Bontong Road', 'Hamden', 'CT', '06517', '2039887764'),
(2, '19 Campbell Avenue', 'West Haven', 'CT', '06516', '2039325990'),
(3, '72 Campbell Avenue', 'West Haven', 'CT', '06516', '2039329551'),
(4, '141 Campbell Avenue', 'West Haven', 'CT', '06516', '8604815431'),
(5, '47 Boston Post Road', 'Milford', 'CT', '06460', '2035818854'),
(6, '87 Boston Post Road', 'Milford', 'CT', '06460', '2034916524'),
(7, '971 Boston Post Road', 'Milford', 'CT', '06460', '2038899988'),
(8, '366 Boston Post Road', 'Milford', 'CT', '06460', '7571556181'),
(9, '775 Boston Post Road', 'Milford', 'CT', '06460', '2038574112'),
(10, '42 Main Street', 'East Haven', 'CT', '06513', '2034518696'),
(11, '121 Main Street', 'East Haven', 'CT', '06513', '2039947741'),
(12, '64 Main Street', 'East Haven', 'CT', '06513', '2036666666'),
(13, '872 Main Street Apt 3C', 'East Haven', 'CT', '06513', '2037778477'),
(14, '109 Main Street', 'East Haven', 'CT', '06513', '2037779001'),
(15, '37 Wooster Street', 'New Haven', 'CT', '06511', '2034445464'),
(16, '137 Wooster Street', 'New Haven', 'CT', '06511', '2035555595'),
(17, '239 Wooster Street', 'New Haven', 'CT', '06511', '2039977334'),
(18, '48 Wooster Street', 'New Haven', 'CT', '06511', '2039819888'),
(19, '52 Wooster Street', 'New Haven', 'CT', '06511', '2039876543'),
(20, '19 Leetes Island Road', 'Branford', 'CT', '06405', '2036814249'),
(21, '28 Leetes Island Road', 'Branford', 'CT', '06405', '2035849900'),
(22, '44 Leetes Island Road', 'Branford', 'CT', '06405', '2039888157'),
(23, '77 Leetes Island Road', 'Branford', 'CT', '06405', '2037844481'),
(24, '103 Leetes Island Road', 'Branford', 'CT', '06405', '2031237789'),
(25, '48 Long Hill Road', 'Guilford', 'CT', '06437', '2034567891'),
(26, '99 Long Hill Road', 'Guilford', 'CT', '06437', '2037778891'),
(27, '145 Long Hill Road', 'Guilford', 'CT', '06437', '8604499454'),
(28, '183 Long Hill Road', 'Guilford', 'CT', '06437', '8604428696'),
(29, '33 Long Hill Road', 'Guilford', 'CT', '06437', '2034711727'),
(30, '17 Lambert Road', 'Orange', 'CT', '06418', '8604459050'),
(31, '23 Lambert Road', 'Orange', 'CT', '06418', '2032238945'),
(32, '38 Lambert Road', 'Orange', 'CT', '06418', '8606626548'),
(33, '97 Lambert Road', 'Orange', 'CT', '06418', '2039997623'),
(34, '104 Lambert Road', 'Orange', 'CT', '06418', '8607767674'),
(35, '62 Shepard Avenue', 'Hamden', 'CT', '06514', '2034436790'),
(36, '88 Shepard Avenue', 'Hamden', 'CT', '06514', '2039976564'),
(37, '41 Shepard Avenue', 'Hamden', 'CT', '06514', '2034855893'),
(38, '227 Shepard Avenue', 'Hamden', 'CT', '06514', '2034448815'),
(39, '188 Shepard Avenue', 'Hamden', 'CT', '06514', '2038896773'),
(40, '84 Bridge Street', 'Shelton', 'CT', '06418', '8606679844'),
(41, '13 Bridge Street', 'Shelton', 'CT', '06418', '2039097130'),
(42, '66 Bridge Street', 'Shelton', 'CT', '06418', '8604426655'),
(43, '114 Bridge Street', 'Shelton', 'CT', '06418', '8601141409'),
(44, '137 Bridge Street', 'Shelton', 'CT', '06418', '2037891234'),
(45, '55 Beach Street', 'West Haven', 'CT', '06516', '2039343474'),
(46, '123 street', 'West Haven', 'CT', '06516', '1234567890'),
(58, '12 Blake St.', 'Milford', 'CT', '06460', '2035554904'),
(59, '12 Blake St', 'Milford', 'CT', '06460', '2035554904'),
(60, '12 Blake Street', 'Milford', 'CT', '06460', '2035551234'),
(61, '55 Terrance Ave', 'Milford', 'CT', '06460', '1234567890'),
(62, '44 State St', 'New Haven', 'CT', '01122', '2035554679'),
(63, '20 Fake Street', 'West Haven', 'CT', '06516', '2035556677'),
(66, '123 Test St.', 'Milford', 'CT', '06460', '2035558745'),
(67, '123 fake street', 'West Haven', 'Ct', '06516', '2035551234');
...
CREATE TABLE IF NOT EXISTS `employee_sales` (
  `sale_no` int(20) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `employee_sales` (`sale_no`, `prod_id`, `employee_id`, `date`, `branch_id`) VALUES
(1, 1, 1, '2017-03-21', 1),
(2, 2, 4, '2017-03-20', 1),
(3, 1, 1, '2017-03-21', 1),
(4, 3, 1, '2017-03-21', 1),
...
(13, 5, 9, '2017-03-15', 3),
(14, 2, 9, '2017-03-15', 3),
(15, 6, 10, '2017-03-13', 2),
(16, 5, 10, '2017-03-14', 2),
(17, 3, 11, '2017-03-21', 2),
(18, 1, 12, '2017-03-11', 2),
(19, 3, 12, '2017-03-11', 2),
(20, 2, 14, '2017-03-15', 2),
(21, 1, 15, '2017-03-02', 4),
(22, 3, 15, '2017-03-02', 4),
(23, 5, 15, '2017-03-12', 4),
(24, 1, 17, '2017-03-06', 4),
(25, 1, 17, '2017-03-09', 4),
(26, 1, 17, '2017-03-09', 4),
(27, 10, 18, '2017-03-20', 4),
(28, 4, 19, '2017-03-19', 4),
(29, 7, 19, '2017-03-16', 4),
(30, 5, 20, '2017-03-21', 5),
(31, 1, 21, '2017-03-21', 5),
(32, 3, 21, '2017-03-13', 5),
(33, 7, 21, '2017-03-14', 5),
(34, 1, 23, '2017-03-07', 5),
(35, 1, 24, '2017-03-21', 5),
(36, 8, 24, '2017-03-03', 5),
(37, 9, 25, '2017-03-18', 6),
(38, 10, 26, '2017-03-09', 6),
(39, 2, 26, '2017-03-21', 6),
(40, 5, 27, '2017-03-01', 6),
(41, 5, 29, '2017-03-08', 6),
(42, 1, 29, '2017-03-21', 6),
(43, 3, 29, '2017-03-21', 6),
(44, 6, 30, '2017-03-12', 7),
(45, 6, 31, '2017-03-15', 7),
(46, 1, 32, '2017-03-21', 7),
(47, 3, 32, '2017-03-21', 7),
(48, 10, 33, '2017-03-16', 7),
(49, 2, 34, '2017-03-18', 7),
(50, 1, 35, '2017-03-09', 8),
(51, 3, 35, '2017-03-09', 8),
(52, 5, 35, '2017-03-21', 8),
(53, 6, 37, '2017-03-04', 8),
(54, 2, 38, '2017-03-06', 8),
(55, 8, 39, '2017-03-17', 8),
(56, 6, 39, '2017-03-21', 8),
(57, 1, 40, '2017-03-21', 9),
(58, 3, 40, '2017-03-21', 9),
(59, 5, 40, '2017-03-16', 9),
(60, 4, 40, '2017-03-03', 9),
(61, 10, 41, '2017-03-15', 9),
(62, 2, 41, '2017-03-21', 9),
(63, 1, 42, '2017-03-01', 9),
(64, 1, 43, '2017-03-20', 9),
(65, 3, 43, '2017-03-20', 9),
(66, 5, 43, '2017-03-10', 9),
(67, 2, 44, '2017-03-02', 9);
...
INSERT INTO `employees` (`id`, `first_name`, `last_name`, `branch_id`) VALUES
(1, 'Mike', 'Peals', 1),
(3, 'Netra', 'Nagaraj', 1),
(4, 'Jon', 'Waterhouse', 1),
(5, 'Sandra', 'Whiteman', 3),
...
(16, 'Jade', 'Saliva', 4),
(17, 'George', 'Poorman', 4),
(18, 'Christine', 'Pastrami', 4),
(19, 'Elizabeth', 'McQueen', 4),
(20, 'Peter', 'Griffin', 5),
(21, 'Glen', 'Quagmire', 5),
(22, 'Adam', 'West', 5),
(23, 'Cleveland', 'Brown', 5),
(24, 'Tricia', 'Takanawa', 5),
(25, 'Gina', 'Esto', 6),
(26, 'Jack', 'Charlotte', 6),
(27, 'Jorge', 'Castillo', 6),
(28, 'Ruben', 'Casto', 6),
(29, 'Tabitha', 'Jenkins', 6),
(30, 'Robert', 'Duffus', 7),
(31, 'Dave', 'Metos', 7),
(32, 'Julia', 'Cipriani', 7),
(33, 'Priceless', 'Johnson', 7),
(34, 'Ahaid', 'Butt', 7),
(35, 'Stuffy', 'McStuffins', 8),
(36, 'Wulfric', 'Stormcloack', 8),
(37, 'Arngeir', 'Greybeard', 8),
(38, 'Magnus', 'Dracor', 8),
(39, 'Charlotte', 'Valencia', 8),
(40, 'Tommy', 'Pickles', 9),
(41, 'Doug', 'Funnie', 9),
(42, 'Patty', 'Mayonnaise', 9),
(43, 'Arnold', 'Shortman', 9),
(44, 'Norbert', 'Beaver', 9),
(45, 'Alyssa', 'Clark', 1),
(61, 'Joseph', 'Kane', 4),
(62, 'Emily', 'Johnson', 6),
...
INSERT INTO `terminated_employees` (`id`, `first_name`, `last_name`, `branch_id`) VALUES
(2, 'Matt', 'Martinaj', 1),
(46, 'test', 't', 3),
(58, 'Stephanie', 'Palmer', 3),
(59, 'Stephanie', 'Palmer', 3),
(60, 'Steph', 'Palmer', 3),
(66, 'Jake', 'Campbell', 3),
(67, 'Jeff', 'Besos', 2);
...
--
-- Constraints for table `employee_sales`
--
ALTER TABLE `employee_sales`
  ADD CONSTRAINT `employee_sales_ibfk_1` FOREIGN KEY (`prod_id`) REFERENCES `products` (`prod_id`),
  ADD CONSTRAINT `employee_sales_ibfk_2` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`branch_id`),
  ADD CONSTRAINT `employee_sales_ibfk_3` FOREIGN KEY (`employee_id`) REFERENCES `employee_contact` (`id`);
...
--
-- Constraints for table `terminated_employees`
--
ALTER TABLE `terminated_employees`
  ADD CONSTRAINT `terminated_employees_ibfk_1` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`branch_id`);
